...
public class Player {
    ...
    // return getScore(gameState, player);
    // }
    ...
    private int getScore(GameState gameState, int player) {
        ...
        // }
        // System.err.println(
        // "Getting score with Player = " + player + " Me = " + this.me + " and Opponent
        // = " + this.opponent);

        if (!gameState.isEOG())
            return evaluateBoard(gameState, player);
